...
<script>
  ...
  document
    .getElementById("id_modalidad")
    .addEventListener("change", limpiarCarritoYTabla);
</script>
<script>
    ...
    selectElement.addEventListener("change", () => {
      ...
      fetch("<?php echo URL_API_CARLITOS ?>/api-reservahabitaciones.php")
        ...
        .then((reservaHabitaciones) => {
          const producto = reservaHabitaciones.find(
            (reservaHab) => reservaHab.nro_habitacion === nroHabitacion
          );
          const selectTipo = document.getElementById("tipo");
...
<script>
  function RegistrarDatos() {
    ...
    var lugar_procedencia = document.getElementById(
    ...
    var observaciones_hospedaje = document.getElementById(
