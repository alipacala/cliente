...
<div class="container my-5 main-cont">
  ...
  <div class="card">
    <div class="card-header py-3">
      <h2 class="text-center">Inventario valorado</h2>
    </div>
    <div class="card-body">
      <div class="row mb-3">
        <div class="col-md-2">
        ...
        <table id="tabla-documentos" class="table table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th class="text-center" rowspan="2">COSTO UNITARIO</th>
...
<script>
        ...
        for (let grupo in tipos[tipo]) {
          ...
          tipos[tipo][grupo].forEach((producto) => {
            ...
            rowProductoCarta.innerHTML = ` 
              ...
              <td class="text-center">${(+producto.SALIDAS_OTROS).toFixed(
                0
              )}</td>
              <td class="text-center">${(+producto.SALIDAS_VENTAS).toFixed(
                0
              )}</td>
            ...
            totalValorTotal += +producto.VALOR_TOTAL;
          });
        }
      }
  ...
  function agregarFilaTotal(totales) {
    ...
    const existenciasTotal = row.insertCell();
    existenciasTotal.innerHTML = totales.totalExistencia.toFixed(0);
    existenciasTotal.classList.add("text-center");

    const celdaVacia = row.insertCell();
    celdaVacia.colSpan = 2;

    const valorTotal = row.insertCell();
    valorTotal.innerHTML = `S/ ${formatearCantidad(totales.totalValorTotal)}`;
    valorTotal.classList.add("text-end");
  }
